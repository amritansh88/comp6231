...
public class FrontEndDriver extends FrontEndImpl{
	...
	public static void main(String args[]) throws SocketException
	{
		...
		DatagramSocket replicaToFrontEnd = new DatagramSocket(Configuration.RM_TO_FRONTEND_PORT_NUMBER);
		...
		(new Thread( new ReplicaMessageListener(frontEnd, replicaToFrontEnd))).start();
	}
}
